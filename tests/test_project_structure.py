...
class ProjectStructureTests(unittest.TestCase):
    ...
    def test_transitink_branding_keeps_firmware_version_unchanged(self):
        ...
        self.assertIn('#define FIRMWARE_VERSION "1.2.3"', config)
        self.assertIn(
            '"https://williamlululu.github.io/transitink-os"', config
        )
        self.assertNotIn("zerie55699.github.io/transitink-os", config)
